...
<div class="content">
  <div class="login-box">
	...
	<form action="delete.php" method="post">
		<select class="select_button"  name="fileToDelete" id="fileToDelete" required>
			<?php
			$directory = '../uploads/';
        ...
        <span></span>
        <span></span>
		<button type="submit" value="Delete File">Delete File</button>
		</a>
	</form>
